...
print("Nhập localhost: "); localhost = input() #localhost
print("Nhập user: "); your_username = input() #root
print("Nhập password: "); your_password = input() 
print("Nhập database: "); your_database = input() 
...
#Tạo đường dẫn file sql 
sql_file ='gerate-db.sql'



#Tạo thao tác random ngày tháng năm 
...
# Chương trình sẽ tự kết nối vào mysql và chạy file generate-db 
path = f'D:\\nguyen\\Material\\IT004.N21.CTTN\\Assigment2\\gerate-db.sql'
# generatedb_statement = f'source {os.path.join(folder_path, sql_file)}'
generatedb_statement = f'source {path}'
cursor.execute(generatedb_statement)
